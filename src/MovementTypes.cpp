...
void Roaming::doMove(std::shared_ptr<Player> player, std::shared_ptr<Game> game, Zombie* zombie, int speed) {
    float angle = 0;
...
void Offensive::doMove(std::shared_ptr<Player> player, std::shared_ptr<Game> game, Zombie* zombie, int speed) {
